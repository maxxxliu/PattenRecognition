...
def train_nn_classification_model(
    ...
    for period in range(0, periods):
        ...
        test_prediction = classifier.predict(input_fn=predict_test_input_fn)
        test_prediction = np.array([item['class_ids'][0] for item in test_prediction])
    ...
    accuracy_v = metrics.accuracy_score(validation_targets, final_predictions)
    print "Final accuracy (on validation data): %0.2f" % accuracy_v

    accuracy_t = metrics.accuracy_score(test_targets, test_prediction)
    print "Accuracy on test data: %0.2f" % accuracy_t
...
weights0 = classifier.get_variable_value("linear/linear_model/pixels/weights")
